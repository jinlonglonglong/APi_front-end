                ...
                <BuyCoinContainer>
                    ...
                    <SubTabContentContainer>
                        ...
                        <CoinKindItems>
                            ...
                            <SplitItem>
                                <CoinKindSubTitle className='CoinKindSubTitle'>{t("244")} </CoinKindSubTitle>
                                <PriceBox>
                                {t("245")}
                                </PriceBox>
                            </SplitItem>
                        ...
                        <CoinKindItems>
                            ...
                            <SplitItem>
                                <CoinKindSubTitle className='CoinKindSubTitle'>{t("246")}</CoinKindSubTitle>
                                <PriceBox>
                                {t("247")}
                                </PriceBox>
                            </SplitItem>
                        ...
                        <ItemItemDetail>{t("250")}<input type="Number" /></ItemItemDetail>
                        <ItemItemDetail>{t("251")}<input type="Number" /></ItemItemDetail>

                        <InputTradeFee>
                            <ItemsTitle>{t("252")}</ItemsTitle>
                            <InputBox>{t("253")}</InputBox>
                        </InputTradeFee>
