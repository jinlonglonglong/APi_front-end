            ...
            <ItemsBox>
                ...
                <BuyCoinContainer>
                    ...
                    <SubTabContentContainer>
                        ...
                        <CoinKindItems>
                            <CoinKindPriceItem>
                                <CoinKindSubTitle className='CoinKindSubTitle'>{t("231")} </CoinKindSubTitle>
                                <PriceBox>
                                {t("232")}
                                </PriceBox>
                            </CoinKindPriceItem>
                            <CoinKindItem>
                                <SwitchContainer>{t("233")}<Switch defaultChecked onChange={onChangeSwitch} /></SwitchContainer>
                                <PriceBox>
                                {t("234")}
                                </PriceBox>
                            </CoinKindItem>
                        ...
                        <CoinKindItems>
                            <SplitItem>
                                <CoinKindSubTitle className='CoinKindSubTitle'>{t("235")} </CoinKindSubTitle>
                                <PriceBox>
                                {t("236")}
                                </PriceBox>
                            </SplitItem>
                        ...
                        <ItemItemDetail>{t("237")}<Switch defaultChecked onChange={onChangeSwitch} /></ItemItemDetail>

                        <InputTradeFee>{t("238")}
                            <InputBox>{t("239")}</InputBox>
                        </InputTradeFee>

                    </SubTabContentContainer>
                </BuyCoinContainer>

                <ItemBtn>{t("240")}</ItemBtn>
