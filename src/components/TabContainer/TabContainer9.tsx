            ...
            <ItemsBox>
                ...
                <BuyCoinContainer>
                    <SubTabContentContainer>
                        <CoinKindItems>
                            <SplitItem>
                                <CoinKindSubTitle className='CoinKindSubTitle'>{t("261")} </CoinKindSubTitle>
                                <PriceBox>
                                {t("262")} 
                                </PriceBox>
                            </SplitItem>
                        ...
                        <CoinKindItems>
                            <SplitItem>
                                <CoinKindSubTitle className='CoinKindSubTitle'>{t("263")}  </CoinKindSubTitle>
                                <PriceBox>
                                {t("264")} 
                                </PriceBox>
                            </SplitItem>
                        ...
                        <CoinKindItems>
                            <SplitItem>
                                <CoinKindSubTitle className='CoinKindSubTitle'>{t("265")}  </CoinKindSubTitle>
                                <PriceBox>
                                {t("266")} 
                                </PriceBox>
                            </SplitItem>
                        ...
                        <CoinKindItems>
                            <SplitItem>
                                <CoinKindSubTitle className='CoinKindSubTitle'>{t("267")}  </CoinKindSubTitle>
                                <PriceBox>
                                {t("268")} 
                                </PriceBox>
                            </SplitItem>
