...
`
const ENNewsContent = styled.div`
color: #15141F;
font-family: Source Han Sans CN;
font-size: 14px;
font-style: normal;
        ...
        <ContentContainer>
          <NewsContainer>
            ...
            <NewsBox>
              ...
              <ENNewsContent>BlockBeats 消息，9 月 23 日，Cryptoslam 数据显示过去 30 天销售额最高的 NFT 藏品系列为 DMarket (约3133 万美元)，超过 BAYC 过去 30 天销售额 (约 186.</ENNewsContent>
              <NewsContent><TagBoxItem>译文</TagBoxItem>BlockBeats 消息，9 月 23 日，Cryptoslam 数据显示过去 30 天销售额最高的 NFT 藏品系列为 DMarket (约3133 万美元)，超过 BAYC 过去 30 天销售额 (约 186.</NewsContent>
            </NewsBox>
          </NewsContainer>
        </ContentContainer>
